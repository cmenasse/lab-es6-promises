...
Promises = [];
brusselsSprouts.forEach((x,idx) => Promises.push(obtainInstruction('brusselsSprouts', idx)));

Promise.all(Promises).then((values) => {
  values.forEach(x => document.querySelector("#brusselsSprouts").innerHTML +=  `<li>${x}</li>`);
